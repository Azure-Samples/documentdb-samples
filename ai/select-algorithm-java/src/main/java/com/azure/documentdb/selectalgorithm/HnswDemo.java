...
public class HnswDemo {
    ...
    public static void createHnswIndex(MongoCollection<Document> collection, String vectorField, int dimensions, String similarity) {
        System.out.println("  Creating HNSW vector index...");

        Document indexDefinition = new Document()
                .append("name", "hnsw_index_" + vectorField)
    ...
    public static void run() {
        System.out.println("\n========================================");
        System.out.println("  HNSW (Hierarchical Navigable Small World) Index Demo");
        System.out.println("========================================\n");
        ...
        try (MongoClient mongoClient = Utils.getMongoClient()) {
            ...
            System.out.println("\n  Performing vector search with HNSW index...");
        ...
        System.out.println("  HNSW Demo complete.\n");
    }
}
