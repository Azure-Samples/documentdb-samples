...
description: "This sample demonstrates vector search capabilities using Azure DocumentDB with Python. It includes implementations of three different vector index types including DiskANN, HNSW, and IVF, along with utilities for embedding generation and data management."
